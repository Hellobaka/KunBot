...
namespace me.cqp.luohuaming.iKun.PublicInfos.PetAttribute.AttributeB
{
    public class AttributeB : IPetAttribute
    {
        ...
        public static AttributeB RandomCreate() => new(CommonHelper.Random.Next(1, AttributeBMap.Count + 1));
        ...
        /// 降低幻化失败率
        /// </summary>
        /// <param name="fail">基础失败率(0.1)</param>
        ...
        /// 降低幻化失败后损失体重比率
        /// </summary>
        /// <param name="lost">基础损失率(0.95)</param>
