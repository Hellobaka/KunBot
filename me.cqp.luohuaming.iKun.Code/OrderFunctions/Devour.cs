...
namespace me.cqp.luohuaming.iKun.Code.OrderFunctions
{
    public class Devour : IOrderModel
    {
        ...
        public FunctionResult Execute(CQGroupMessageEventArgs e)
        {
            ...
            {
                sendText.MsgToSend.Add(string.Format(AppConfig.ReplyDevourSuccess, kun.ToString(), playerInfo, targetKun.ToString(), r.Increment.ToShortNumber(), r.CurrentWeight.ToShortNumber(), r.TargetDecrement.ToShortNumber(), r.TargetCurrentWeight.ToShortNumber()));
                return result;
            }
            else
            {
