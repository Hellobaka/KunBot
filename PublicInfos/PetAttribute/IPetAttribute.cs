...
namespace me.cqp.luohuaming.iKun.PublicInfos.PetAttribute
{
    ...
    public abstract class IPetAttribute
    {
        ...
        private Logger Logger { get; set; } = new("基础词缀");
    ...
    public class PetAttributeRandomInsatantiator
    {
        ...
        public IPetAttribute GetInstanceByID(bool attrbuteId, int id)
        {
            if (attrbuteId)
            {
                ...
                {
                    Enums.Attribute.Jin => new AttributeA.Jin(),
                    Enums.Attribute.Mu => new AttributeA.Mu(),
                    Enums.Attribute.Shui => new AttributeA.Shui(),
                    Enums.Attribute.Huo => new AttributeA.Huo(),
                    Enums.Attribute.Tu => new AttributeA.Tu(),
                    Enums.Attribute.Feng => new AttributeA.Feng(),
                    Enums.Attribute.Lei => new AttributeA.Lei(),
                    Enums.Attribute.Yin => new AttributeA.Yin(),
                    Enums.Attribute.Yang => new AttributeA.Yang(),
                    _ => new AttributeA.None(),
                };
            }
            else
            {
