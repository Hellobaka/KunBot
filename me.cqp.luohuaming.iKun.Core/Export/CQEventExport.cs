...
using me.cqp.luohuaming.iKunCore;
using me.cqp.luohuaming.iKunCore.Domain;
using me.cqp.luohuaming.iKun.Sdk.Cqp;
using me.cqp.luohuaming.iKun.Sdk.Cqp.Enum;
using me.cqp.luohuaming.iKun.Sdk.Cqp.EventArgs;
using me.cqp.luohuaming.iKun.Sdk.Cqp.Interface;
using me.cqp.luohuaming.iKun.Sdk.Cqp.Expand;
using me.cqp.luohuaming.iKun.Sdk.Cqp.Model;
using Unity;
using Unity.Injection;

namespace me.cqp.luohuaming.iKunApp.Export
{
	/// <summary>	
	/// 表示酷Q事件导出的类	
	/// </summary>	
	...
	{	
		...
		{	
			return "9,me.cqp.luohuaming.iKun";	
		}	
		...
		{	
			...
			Type appDataType = typeof (AppData);	
			// 注册一个 CQApi 实例	
			AppInfo appInfo = new AppInfo ("me.cqp.luohuaming.iKun", 1, 9, "鲲鲲物语", "1.0.18", 1, "落花茗", "养鲲 斗鲲", authCode);	
			...
			AppData.UnityContainer.RegisterInstance<CQLog> ("me.cqp.luohuaming.iKun", AppData.CQLog);	
